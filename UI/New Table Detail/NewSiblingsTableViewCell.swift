//
//  NewSiblingsTableViewCell.swift
//  UI
//
...
class NewSiblingsTableViewCell: UITableViewCell {

    

    

        static let identifier = "NewSiblingsTableViewCell"
        ...
        public func configure(_ viewModels:NewSiblings){
